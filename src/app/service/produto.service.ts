...
export class ProdutoService {
  ...
  obterProdutosComPaginacaoEComFiltro = (pag: number, res: number, filtro: string): Observable<Produto[]> =>
    this.http.get<Produto[]>((this.ProdutoApiUrl + "/pag/" + pag + "/res/" + res + "/filtro/" + filtro), {
      headers: this.authService.buildHeaders(),
    });
